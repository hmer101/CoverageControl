...
/*!
 * \file adaptive_system.h
 * \brief The file contains the AdaptiveSystem class, which is the main class
 * for the adaptive sampling library.
 */

#ifndef CPPSRC_CORE_INCLUDE_COVERAGECONTROL_ADAPTIVE_SYSTEM_H_
#define CPPSRC_CORE_INCLUDE_COVERAGECONTROL_ADAPTIVE_SYSTEM_H_
 ...
 * \brief The AdaptiveSystem class is the main class for the adaptive sampling
 * library.
 */
class AdaptiveSystem {
...
public:
 ...
 public:
   ...
   */
  explicit AdaptiveSystem(Parameters const &params);
   ...
   */
  AdaptiveSystem(Parameters const &params, int const num_gaussians,
   ...
   */
  AdaptiveSystem(Parameters const &params, WorldIDF const &world_idf,
   ...
   * \param robot_positions Initial positions of the robots
   */
  AdaptiveSystem(Parameters const &params,
